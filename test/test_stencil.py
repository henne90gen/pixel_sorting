...
class StencilTests(unittest.TestCase):
    ...
    def testRectangle(self):
        ...
        rect.x = 0
        rect.y = 0
        self.assertEqual(rect.put_in_pixels(self.rect_pixels, self.rect_out_result), self.rect_in_result)
        rect.x = 3
        rect.y = 3
    ...
    def testCirlce(self):
        ...
        self.assertEqual(circle.put_in_pixels(self.circ_pixels, self.circ_in), self.circ_in_result1)
        circle.radius = 1
        circle.x = 1
        circle.y = 1
